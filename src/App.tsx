...
function About() {
  return (
    <article className="note-list">
      ...
      <p>Die <Link to="/suche">Suche</Link> erschließt die Inhalte über Funktionsnamen, Fachbegriffe und aufgabenbezogene Suchbegriffe. Werkzeugkataloge, typische Aufgaben und Fehlerhilfen bieten weitere Einstiege. Favoriten bleiben lokal in deinem Browser gespeichert – ohne Anmeldung und ohne Synchronisierung zwischen Geräten.</p>
      ...
      <p>Ich habe Wirtschaftsingenieurwesen an der Hochschule Mannheim studiert und mit dem Bachelor of Engineering abgeschlossen. Dabei habe ich mich auf Datenanalyse spezialisiert. Beruflich beschäftige ich mich mit Controlling, Reporting und datenbasierten Auswertungen im Bankenumfeld, insbesondere mit IDA/Cognos.</p>
      <p>In meiner Bachelorarbeit habe ich mich mit der Modernisierung von Reporting-Systemen beschäftigt: von der Analyse fachlicher und technischer Anforderungen über den Vergleich geeigneter Werkzeuge bis zur prototypischen Umsetzung datenbankgestützter Berichte und interaktiver Auswertungen.</p>
      <p>Mit Power BI beschäftige ich mich im Zusammenhang mit Datenaufbereitung, Datenmodellierung und der verständlichen Darstellung von Analyseergebnissen. Besonders interessiert mich, wie aus einer fachlichen Fragestellung eine nachvollziehbare Auswertung entsteht. Mein Wissen und meine praktische Erfahrung in Power BI, IDA und Excel möchte ich gezielt weiterentwickeln.</p>
      <p>BankBI Kompass ist dafür mein fortlaufendes Praxis- und Wissensprojekt. Hier strukturiere ich Methoden, vertiefe Zusammenhänge und dokumentiere Lösungswege so, dass sie auch für Kolleginnen und Kollegen sowie andere Anwender nachvollziehbar sind.</p>
